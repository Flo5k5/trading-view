...
// Stochastic
alertcondition(crossover(k, d), title='Stoch K crossover D', message='[rsi-stoch-stochrsi-v1] Stoch Bullish cross')
alertcondition(crossunder(k, d), title='Stoch K crossunder D', message='[rsi-stoch-stochrsi-v1] Stoch Bearish cross')
alertcondition(crossover(k, 80), title='Stoch K crossover 80', message='[rsi-stoch-stochrsi-v1] Stoch K over 80')
alertcondition(crossunder(k, 80), title='Stoch K crossunder 80', message='[rsi-stoch-stochrsi-v1] Stoch K under 80')
alertcondition(crossover(k, 70), title='Stoch K crossover 70', message='[rsi-stoch-stochrsi-v1] Stoch K over 70')
alertcondition(crossunder(k, 70), title='Stoch K crossunder 70', message='[rsi-stoch-stochrsi-v1] Stoch K under 70')
alertcondition(crossover(k, 30), title='Stoch K crossover 30', message='[rsi-stoch-stochrsi-v1] Stoch K over 30')
alertcondition(crossunder(k, 30), title='Stoch K crossunder 30', message='[rsi-stoch-stochrsi-v1] Stoch K under 30')
alertcondition(crossover(k, 20), title='Stoch K crossover 20', message='[rsi-stoch-stochrsi-v1] Stoch K over 20')
alertcondition(crossunder(k, 20), title='Stoch K crossunder 20', message='[rsi-stoch-stochrsi-v1] Stoch K under 20')

// StochasticRsi
alertcondition(crossover(k2, d2), title='StochRsi K crossover D', message='[rsi-stoch-stochrsi-v1] StochRsi Bullish cross')
alertcondition(crossunder(k2, d2), title='StochRsi K crossunder D', message='[rsi-stoch-stochrsi-v1] StochRsi Bearish cross')
alertcondition(crossover(k2, 80), title='StochRsi K crossover 80', message='[rsi-stoch-stochrsi-v1] StochRsi K over 80')
alertcondition(crossunder(k2, 80), title='StochRsi K crossunder 80', message='[rsi-stoch-stochrsi-v1] StochRsi K under 80')
alertcondition(crossover(k2, 70), title='StochRsi K crossover 70', message='[rsi-stoch-stochrsi-v1] StochRsi K over 70')
alertcondition(crossunder(k2, 70), title='StochRsi K crossunder 70', message='[rsi-stoch-stochrsi-v1] StochRsi K under 70')
alertcondition(crossover(k2, 30), title='StochRsi K crossover 30', message='[rsi-stoch-stochrsi-v1] StochRsi K over 30')
alertcondition(crossunder(k2, 30), title='StochRsi K crossunder 30', message='[rsi-stoch-stochrsi-v1] StochRsi K under 30')
alertcondition(crossover(k2, 20), title='StochRsi K crossover 20', message='[rsi-stoch-stochrsi-v1] StochRsi K over 20')
alertcondition(crossunder(k2, 20), title='StochRsi K crossunder 20', message='[rsi-stoch-stochrsi-v1] StochRsi K under 20')
