...
//@version=4
study(title='Weekend Session - Flo5k5', shorttitle='WE Session - Flo5k5', overlay=true)
...
dummy2            = input(title='Weekend Session (input only GMT+0)', type=input.bool, defval=false)
dummy3            = input(title=' ', type=input.bool, defval=false)
inputFromHour     = input(title='From:', type=input.integer, defval=0, minval=0, maxval=23)
...
inputToHour       = input(title='To:', type=input.integer, defval=23, minval=0, maxval=23)
inputToMinute     = input(title=' ', type=input.integer, defval=59, minval=0, maxval=59)
inputToSecond     = input(title=' ', type=input.integer, defval=59, minval=0, maxval=59)
inputWeekdays     = input(title='Week days', type=input.bool, defval=false)
inputWeekend      = input(title='Weekend', type=input.bool, defval=true)
